...
function(ignition_modular_build_library NAME MAJOR_VERSION SOURCE_PATH)
    ...
    # Handle copyright
    file(INSTALL ${SOURCE_PATH}/README.md DESTINATION ${CURRENT_PACKAGES_DIR}/share/ignition-${NAME}${MAJOR_VERSION} RENAME copyright)
...
function(ignition_modular_library)
    set(oneValueArgs NAME VERSION SHA512 REF HEAD_REF PATCHES)
    cmake_parse_arguments(IML "" "${oneValueArgs}" "" ${ARGN} )
